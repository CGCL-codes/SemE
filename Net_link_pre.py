...
class Net(nn.Module):
    ...
    def forward(self, semantic_embedding0, interval0, edge_index0,
        ...
        embedding = self.concat_Layer(embedding0, embedding1, embedding2, embedding3)
...
def running(train_loader, test_loader):
    ...
    semantic_embedding2 = read_semantic_embedding(dataset + "/appa-prone-embedding.txt",
                                                  meta_length2,
                                                  meta_length2 + args.author_num + args.paper_num + args.conf_num)
    ...
    structure_embedding = read_structure_embedding(dataset + "/original-prone-embedding.txt.txt",
    ...
    for epoch in range(args.epochs):
        ...
        for batch, (data_test0, data_test1, target_test) in enumerate(test_loader):
            ...
            out = model(semantic_embedding0=semantic_embedding0, interval0=interval0, edge_index0=edge_index0,
                        ...
                        structure_embedding=structure_embedding[data_test])
